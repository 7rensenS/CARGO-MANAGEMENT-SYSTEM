        ...
        <div class="ftco-cover-1 overlay" style="background-image: url('https://source.unsplash.com/pSyfecRCBQA/1920x780')">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-6">
                <h1>CargoDapp process</h1>
                     <?php
                        include('connection.php');

                        $query = "select * from cargoprocessing where Approve='Not Approved'";
                        ...
                        while ($row = mysql_fetch_row($result))
                        {
                          ...
                          echo '<td><a href=approveCargo1.php?id='.

                        $idval.'>Approve</a></td><td><a href=deleteCargo.php?id='.$idval.'>Delete</a></td>';
                          echo '</tr>';
                          $i = $i + 1;
                        }
                        echo '</table>';
