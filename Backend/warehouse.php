    ...
    <div class="row" style="display:flex; margin-bottom: -15px;">
        ...
        <div class="col-sm-2" style="color: #ff0000; ">
            ...
            <ul id="Side_Menu" class="nav nav-pills nav-stacked">
                <li class='active'><a href="warehouse.php">
                <span class="glyphicon glyphicon-th"></span> Home</a></li>
                <li><a href="AddNewEntry.php"><span class="glyphicon glyphicon-list-alt"></span> Add New Entry</a></li>
                ...
                <li><a href="cargo.php"><span class="glyphicon glyphicon-cog"></span> Cargo</a></li>
        ...
        <div class="col-sm-8" style="background-color: #fff">
            ...
            <div>
                <!-- add content -->
                <h2>Shipping cargo</h2>
                <?php
                        include('connection.php');

                        $query = "select * from cargoprocessing where Approve='Approved' and Ship='Shipping Pending' and SDistrict='$District'";
                        ...
                        //     $c_row="****";
                          ...
                          echo '<td><a href=shipCargo1.php?id='.$idval.'>Approve</a></td>';  //<td><a href=deleteCargo.php?id='.$idval.'>Delete</a></td>
                          echo '</tr>';
                          $i = $i + 1;
                        }
                        echo '</table>';
